...
export default function MoreServices() {
  ...
  const message =
    "Hello ZibaGo, I want a professional and experienced driver. Please assist me.";
  ...
  return (
    <section
      ...
      className="py-24 bg-black/60 backdrop-blur-md text-white"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2
            id="services-heading"
            className="text-4xl md:text-5xl font-black mt-5"
          >
          ...
          <p className="text-gray-400 mt-6 max-w-3xl mx-auto leading-8">
            ZibaGo is building a convenient mobility platform for
            customers in Bhubaneswar and Odisha. From car rental
            with professional drivers to wedding car services and
            vehicle partnerships, explore the services currently
            available through ZibaGo.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 mt-5 leading-8">
              Don't want to drive? Choose a car rental with a
              professional driver for city travel, business trips,
              airport transfers, special occasions and outstation
              journeys, subject to availability.
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Contact ZibaGo on WhatsApp about professional driver service"
              className="inline-block mt-8 bg-orange-500 hover:bg-orange-600 transition px-6 py-3 rounded-full font-semibold"
            >
              Contact Us
            </a>
          ...
          >
            ...
            <div
              className="w-16 h-16 rounded-full bg-yellow-500 flex items-center justify-center mb-6"
              aria-hidden="true"
            >
              <CarFront
                className="text-black"
            ...
            <p className="text-gray-400 mt-5 leading-8">
              Make your special day memorable with a comfortable
              and stylish wedding car. Contact ZibaGo to learn
              about available vehicles and rental options for
          ...
          >
            ...
            <h3 className="text-2xl font-bold">
              Rent Your Car With ZibaGo
            </h3>

            <p className="text-gray-400 mt-5 leading-8">
              Own a car? Become a ZibaGo partner and list your
              vehicle on our platform. We help connect vehicle
              owners with customers while providing support
