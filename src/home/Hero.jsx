...
export default function Hero() {
  ...
  return (
    <section
      className="relative min-h-screen flex items-center overflow-hidden pt-28 lg:pt-32"
      aria-labelledby="hero-heading"
    >
      {/* Background Glow */}
      <div
        aria-hidden="true"
        className="absolute right-0 top-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-orange-500 rounded-full blur-[180px] opacity-20"
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-16 items-center">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <div className="relative z-20 inline-flex items-center gap-2 px-5 py-2 rounded-full border border-orange-500 text-orange-400 mb-8">
            Premium Car Rental in Bhubaneswar
          </div>
          ...
          >
            Car Rental in
            <br />
            <span className="text-orange-500">Bhubaneswar & Odisha</span>
            <br />
            with ZibaGo
          </h1>
          ...
          {/* SEO INTRODUCTION */}
          <p className="text-gray-400 text-lg mt-8 max-w-xl leading-8">
            Find reliable and affordable cars for rent in Bhubaneswar and across
            Odisha. Choose a car for local travel, business trips, airport
            travel and other transportation needs with ZibaGo.
          </p>
          ...
          <div className="flex flex-wrap gap-5 mt-10">
            ...
            <button
              ...
              aria-label="View cars available for rent in Bhubaneswar"
              className="relative z-20 flex items-center gap-3 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 duration-300 px-8 py-4 rounded-full font-semibold cursor-pointer"
            >
              View Cars
        ...
        >
          <video
            ...
            playsInline
            preload="metadata"
            aria-label="ZibaGo car rental video"
            className="w-full rounded-3xl object-cover shadow-[0_40px_80px_rgba(249,115,22,0.35)]"
          >
            <source src={heroVideo} type="video/mp4" />
